 ...
 * Code
 */
const Specialities = ({ getMembersWordpress }) => (
  <section id="home-specialities" className="d-flex flex-column justify-content-center align-items-center full-height bg-home-darker">
    ...
    <div id="home-specialities-list" className="d-flex justify-content-around flex-wrap col-9 col-md-9 col-xl-6">
      <NavLink activeClassName="" exact to="/members" onClick={getMembersWordpress} className="d-flex flex-column col-12 col-md-4 mt-7 mt-md-0">
      ...
      <NavLink activeClassName="" exact to="/members" className="d-flex flex-column col-12 col-md-4 mt-7 mt-md-0">
...
Specialities.propTypes = {
  getMembersWordpress: PropTypes.func.isRequired,
};
