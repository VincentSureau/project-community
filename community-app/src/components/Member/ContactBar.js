...
const ContactBar = ({
  ...
  <div id="member-info-contactbar" className="row w-100 mx-0 justify-content-center">
    <div className="col-12 col-md-4 d-flex float-right order-1 justify-content-md-end justify-content-center align-items-md-end align-items-center pb-3">
      ...
      { ((linkGithub !== null) && (linkGithub !== '')) && <a href={linkGithub}><FaGithub className="text-white" /></a>}
      { ((linkLinkedin !== null) && (linkLinkedin !== '')) && <a href={linkLinkedin}><FaLinkedinIn className="text-white" /></a>}
      { ((linkPersonal !== null) && (linkPersonal !== '')) && <a href={linkPersonal}><FaDesktop className="text-white" /></a>}
    </div>
