...
var ReferenceArrayInputController = /** @class */ (function (_super) {
    ...
    function ReferenceArrayInputController(props) {
        ...
        _this.fetchOptions = function (props) {
            if (props === void 0) { props = _this.props; }
            var crudGetMatching = props.crudGetMatching, reference = props.reference, source = props.source, resource = props.resource, referenceSource = props.referenceSource;
...
export { ReferenceArrayInputController };
