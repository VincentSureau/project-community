 ...
 * );
 */
exports.FormDataConsumer = function (_a) {
    var children = _a.children, formData = _a.formData, source = _a.source, index = _a.index, rest = __rest(_a, ["children", "formData", "source", "index"]);
...
exports.FormDataConsumer.propTypes = {
...
var mapStateToProps = function (state, _a) {
    ...
    return ({
        formData: redux_form_1.getFormValues(REDUX_FORM_NAME)(state) || record,
    });
};
exports.default = react_redux_1.connect(mapStateToProps)(exports.FormDataConsumer);
