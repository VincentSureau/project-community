...
exports.default = (function (customReducers, locale, messages) {
    return redux_1.combineReducers(__assign({ admin: admin_1.default, i18n: i18n_1.default(locale, messages), form: redux_form_1.reducer, routing: react_router_redux_1.routerReducer }, customReducers));
});
