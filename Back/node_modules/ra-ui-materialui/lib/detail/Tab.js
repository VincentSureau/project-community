    ...
    function Tab() {
        ...
        _this.renderContent = function (_a) {
            ...
            return (react_1.default.createElement("span", { className: className }, react_1.default.Children.map(children, function (field) {
                return field && (react_1.default.createElement("div", { key: field.props.source, className: classnames_1.default('ra-field', "ra-field-" + field.props.source, field.props.className) }, field.props.addLabel ? (react_1.default.createElement(Labeled_1.default, __assign({ label: field.props.label, source: field.props.source }, sanitizeRestProps(rest)), field)) : typeof field.type === 'string' ? (field) : (react_1.default.cloneElement(field, sanitizeRestProps(rest)))));
            })));
        };
        return _this;
    }
