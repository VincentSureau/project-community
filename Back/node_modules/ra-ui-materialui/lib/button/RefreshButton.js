...
var RefreshButton = /** @class */ (function (_super) {
    ...
    RefreshButton.prototype.render = function () {
        var _a = this.props, label = _a.label, refreshView = _a.refreshView, rest = __rest(_a, ["label", "refreshView"]);
        return (react_1.default.createElement(Button_1.default, __assign({ label: label, onClick: this.handleClick }, rest),
