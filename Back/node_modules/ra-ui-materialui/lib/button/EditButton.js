...
var EditButton = function (_a) {
    var _b = _a.basePath, basePath = _b === void 0 ? '' : _b, _c = _a.label, label = _c === void 0 ? 'ra.action.edit' : _c, _d = _a.record, record = _d === void 0 ? {} : _d, rest = __rest(_a, ["basePath", "label", "record"]);
    return (react_1.default.createElement(Button_1.default, __assign({ component: react_router_dom_1.Link, to: ra_core_1.linkToRecord(basePath, record.id), label: label }, rest),
