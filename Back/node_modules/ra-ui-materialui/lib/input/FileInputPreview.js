...
var FileInputPreview = /** @class */ (function (_super) {
    ...
    FileInputPreview.prototype.render = function () {
        var _a = this.props, children = _a.children, _b = _a.classes, classes = _b === void 0 ? {} : _b, className = _a.className, onRemove = _a.onRemove, revokeObjectURL = _a.revokeObjectURL, file = _a.file, rest = __rest(_a, ["children", "classes", "className", "onRemove", "revokeObjectURL", "file"]);
        return (react_1.default.createElement("div", __assign({ className: className }, rest),
            react_1.default.createElement(IconButton_1.default, { className: classes.removeButton, onClick: onRemove },
...
exports.default = styles_1.withStyles(styles)(FileInputPreview);
