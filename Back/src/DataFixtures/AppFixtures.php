...
class AppFixtures extends Fixture
{
    ...
    public function load(ObjectManager $manager)
    {
        ...
        $community->setDescription('L\'objectif du projet était de réaliser un site internet communautaire pour les anciens étudiants de O\'clock : un mélange de LinkedIn et des Copains d’Avant (une partie étant publique et l’autre privée).
        Il s’agit d’une plateforme permettant de référencer tous les étudiants et anciens étudiants de O\'clock en recensant leurs différents profils et projets.
        Plusieurs avantages :
