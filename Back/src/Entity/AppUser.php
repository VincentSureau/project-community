 ...
 *     itemOperations={
 *         "get",
 *         "put"={"access_control"="is_granted('ROLE_COMMUNITY_USER') and object.getEmail() == user.getEmail()", "access_control_message"="Désolé mais tu ne peux modifier que ton profil !"},
 *         "delete"={"access_control"="is_granted('ROLE_COMMUNITY_USER') and object.getEmail() == user.getEmail()", "access_control_message"="Désolé mais tu ne peux pas supprimer un autre utilisateur"}
 *     },
 * )
